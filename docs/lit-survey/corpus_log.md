...
| # | Paper | Authors | Year | Source | Status | Pass |
|---|-------|---------|------|--------|--------|------|
| 1 | Glia: Human-Inspired AI for Systems Design | Hamadanian et al. (MIT) | 2025 | arXiv:2510.27176 | PDF ✅ Pass 1 ✅ | 1 |
| 2 | Confucius: Multi-Agent LLM for Network Mgmt | Wang et al. (Meta/Harvard) | 2025 | SIGCOMM 2025 | PDF ✅ Pass 1 ✅ | 1 |
...
| # | Paper | Authors | Year | Source | Status | Pass |
|---|-------|---------|------|--------|--------|------|
| 14 | NetConfEval | Wang et al. (KTH/Red Hat) | 2024 | CoNEXT 2024 | PDF ✅ | — |
...
| # | Paper | Authors | Year | Source | Status | Pass |
|---|-------|---------|------|--------|--------|------|
| 43 | Osprey: Agentic AI for Scientific Facilities | Hellert (LBNL) | 2026 | LBNL Workshop | Pass 1 ✅ | 1 |
| 44 | Academy: Scalable Agentic Systems for Science | — | 2026 | LBNL Workshop | Pass 1 ✅ | 1 |
| 45 | Flowcept: Multi-Workflow Provenance | Souza et al. (ORNL) | 2024 | eScience 2024 | Pass 1 ✅ | 1 |
| 46 | gpCAM: GP-driven Autonomous Data Acquisition | Noack et al. (LBNL) | 2021 | Nat Rev Phys | pending | — |
| 47 | Colmena: ML-Steered Simulation Campaigns | Ward et al. (Argonne) | 2021 | MLHPC 2021 | pending | — |
| 48 | INTERSECT: Autonomous Experiment Architecture | ORNL | 2024 | — | pending | — |

## Tier 3: Pass 1 Only (Background)

| # | Paper | Year | Source | Reason |
|---|-------|------|--------|--------|
| 49 | DiscoveryWorld (Allen AI) | 2024 | AI2 | benchmark |
| 50 | LangChain/LangGraph | 2024 | framework | framework context |
| 51 | AutoGen | 2024 | COLM | multi-agent baseline |
| 52 | OpenEvolve | 2025 | GitHub | evo search baseline |
| 53 | Reflexion | 2024 | NeurIPS | agent scaffolding |
| 54 | GEPA | 2025 | arXiv | evo search baseline |
| 55 | ShinkaEvolve | 2025 | arXiv | evo search baseline |
| 56 | AssetOpsBench | 2025 | arXiv | industrial benchmark |
| 57 | ShieldGPT / Ciri / LLo11yPop | 2024-25 | various | networking LLM tools |
| 58 | Harnessing Public Code Repos for ML Artifacts | 2024 | ANRW | netUnicorn ecosystem |
| 59 | AI/ML-Driven Traffic Engineering | 2024 | AIMLSys | netUnicorn citing |
| 60 | Intent-Based Mgmt with LLMs (6G-INTENSE) | 2024 | IEEE Network | intent lifecycle |
| 61 | Generative AI for Network Digital Twins | 2025 | ACM Surveys | digital twins |
| 62 | Network Model Generalization (HotNets '22) | 2022 | HotNets | generalization |
| 63 | LLM Agent Survey (Wang et al.) | 2023 | arXiv:2308.11432 | foundational survey |
| 64 | Pensieve | 2017 | SIGCOMM | classic ML-for-net |
| 65 | Lilian Weng Agent Blog Post | 2023 | Blog | orientation |
| 66 | AgentBench | 2024 | ICLR | benchmarking |
| 67 | TheAgentCompany | 2024 | arXiv | benchmarking |
| 68 | MLEBench | 2025 | ICLR | ML agent benchmark |
| 69 | RE-Bench | 2024 | arXiv | R&D agent benchmark |
| 70 | CycleResearcher | 2025 | ICLR | auto research via review |
