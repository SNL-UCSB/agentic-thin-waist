...
Then bring up the stack one of two ways:

**Option A — build from source** (slower, builds every image locally):
...
**Option B — use prebuilt images** (faster, pulls published `snlhub/*` images from Docker Hub):
...
- Linux Traffic Control: [https://man7.org/linux/man-pages/man8/tc.8.html](https://man7.org/linux/man-pages/man8/tc.8.html)
