...
# Config
# ---------------------------------------------------------------------------
ORCH_URL      = os.getenv("ORCH_URL",      "http://localhost:8008").rstrip("/")
...
MEETING_ID   = os.getenv("ZOOM_MEETING_ID",   "87548315231")
PASSCODE     = os.getenv("ZOOM_PASSCODE",     "668868")
...
CTP_LIST_FILE = os.getenv("CTP_LIST_FILE", "/mnt/md0/haarika/ctps_sweep_100mbps_10ms_b.txt")
SWEEP_LIMIT   = int(os.getenv("SWEEP_LIMIT", "0"))          # 0 = no limit
SWEEP_LOG     = os.getenv("SWEEP_LOG", "./sweep_zoom_av_100mbps_10ms_b_progress.jsonl")
