...
MEETING_ID   = os.getenv("ZOOM_MEETING_ID",   "89450530815")
PASSCODE     = os.getenv("ZOOM_PASSCODE",     "812664")
...
CTP_LIST_FILE = os.getenv("CTP_LIST_FILE", "/mnt/md0/haarika/ctps_sweep_10ms.txt")
SWEEP_LIMIT   = int(os.getenv("SWEEP_LIMIT", "0"))          # 0 = no limit
SWEEP_LOG     = os.getenv("SWEEP_LOG", "./sweep_zoom_av_10ms_progress.jsonl")
