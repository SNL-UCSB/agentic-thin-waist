"""
End-to-end smoke test: submit a YouTube playback intent to the orchestrator and
...
Usage (from repo root):
    ...
    ORCH_URL=http://localhost:8005 python3 services/orchestration/scripts/test_orchestration_youtube.py
    ORCH_CONTAINER=orchestration python3 services/orchestration/scripts/test_orchestration_youtube.py
...
def submit_intent() -> str:
    banner("Step 1: Submitting youtube playback intent")
    payload = {
        "intent": INTENT,
