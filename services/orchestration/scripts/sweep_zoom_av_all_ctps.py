...
Key env-var overrides:
    ...
    SWEEP_LOG              JSONL file for progress / resume
                           Default: ./sweep_zoom_av_progress.jsonl
...
MEETING_ID   = os.getenv("ZOOM_MEETING_ID",   "84730470603")
PASSCODE     = os.getenv("ZOOM_PASSCODE",     "213841")
DISPLAY_NAME = os.getenv("ZOOM_DISPLAY_NAME", "Henry")
WAIT_SECONDS = int(os.getenv("ZOOM_WAIT_SECONDS", "60"))
CAPACITY     = int(os.getenv("ZOOM_CAPACITY_MBPS", "6"))
LATENCY      = int(os.getenv("ZOOM_LATENCY_MS",    "100"))
QDISC        = os.getenv("ZOOM_QDISC",             "pfifo")

CTP_LIST_FILE = os.getenv("CTP_LIST_FILE", "/mnt/md0/haarika/ctps.txt")
SWEEP_LIMIT   = int(os.getenv("SWEEP_LIMIT", "0"))          # 0 = no limit
SWEEP_LOG     = os.getenv("SWEEP_LOG", "./sweep_zoom_av_progress.jsonl")
