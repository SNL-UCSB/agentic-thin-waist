...
def run_shell():
    ...
    # Shell actions use NETGENT_USE_LOCAL to decide between direct execution
    # and namespace execution (ip netns exec). On macOS, namespace mode fails
    # because iproute2 is Linux-only — force local mode here.
    os.environ["NETGENT_USE_LOCAL"] = "true"
    client = NetGent()
